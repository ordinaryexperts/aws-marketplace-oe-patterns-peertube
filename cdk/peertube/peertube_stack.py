...
AMI_ID="ami-0ff180926f177fdaf"
AMI_NAME="ordinary-experts-patterns-peertube--20230517-0308"
generated_ami_ids = {
    ...
    "us-east-1": "ami-0ff180926f177fdaf"
}
...
class PeertubeStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        self.data_volume_size_param = CfnParameter(
            ...
            default=100,
            min_value=10,
            description="Required: The size of the storage volume for the EC2 instance. Videos are saved in the S3 bucket after transcoding but are served from this volume before transcoding and other situations."
        )
